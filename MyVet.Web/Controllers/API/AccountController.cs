...
namespace MyVet.Web.Controllers.API
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> PostUser([FromBody] UserRequest request)
        {
            ...
            {
                IsSuccess = true,
                Message = "Se le ha enviado un email a su cuenta de correo. Porfavor confirme para ingresar a la aplicaciòn."
            });
        }
        ...
        public async Task<IActionResult> RecoverPassword([FromBody] EmailRequest request)
        {
            ...
            _mailHelper.SendMail(request.Email, "Cambio de contraseña", $"<h1>Recuperación de contraseña</h1>" +
                $"Para cambiar tu contraseña haz clic en el siguiente link:</br></br>" +
                $"<a href = \"{link}\">RCambiar contraseña</a>");

            return Ok(new Response<object>
            {
                IsSuccess = true,
                Message = "Se ha enviado a tu correo instrucciones para cambiar tu contraseña."
            });
        }
